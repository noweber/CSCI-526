...
def main():
    ...
    for row in data[1:]:
        if row[3] == 'TutorialFogOfWar' and row[8] != '{}':
            list_heatmap_fow.append(row[8])
        elif row[3] == 'Level_One' and row[8] != '{}':
            list_heatmap_level1.append(row[8])
        elif row[3] == 'Level_Two' and row[8] != '{}':
            list_heatmap_level2.append(row[8])
    ...
    fig, ax = plt.subplots()
    im = ax.imshow(heatmap_fow, cmap='coolwarm')
    ...
    fig, ax = plt.subplots()
    im = ax.imshow(heatmap_level1, cmap='coolwarm')
    ax.set_yticks(np.arange(10), labels = ylabel )
    ax.set_xticks(np.arange(5), labels = xlabel[0:5])
    ...
    fig, ax = plt.subplots()
    im = ax.imshow(heatmap_level2, cmap='coolwarm')
    ax.set_yticks(np.arange(10), labels = ylabel )
